...
function previouslySearchedCityList() {
  ...
  lastCity.addClass("h4 city-button");
...
function currentWeather(cityInput) {
  ...
  var geoLink =
    ...
    cityCode +
    "&limit=5&appid=04f50896a4e31a98e332740a88e3546c";
  ...
  fetch(geoLink)
    ...
    .then(function (data) {
      ...
      var theUrl =
        ...
        "&lon=" +
        longitude +
        "&exclude=minutely,hourly,alerts&units=imperial&appid=04f50896a4e31a98e332740a88e3546c";
      ...
      fetch(theUrl)
        ...
        .then(function (data) {
          ...
          var forecastURL =
            ...
            "&lon=" +
            longitude +
            "&appid=04f50896a4e31a98e332740a88e3546c";
          ...
          fetch(forecastURL)
            ...
            .then(function (data) {
              ...
              for (var i = 0; i < data.list.length; i += 8) {
                ...
                tempForecast.text(
                  "Temperature: " +
                    (((data.list[i].main.temp - 273.15) * 9) / 5 + 32).toFixed(
                      2
                    ) +
                    " F"
                ); // Formula converts Kelvin temperature to Farenheit

                humidityForecast.text(
                ...
                var forecastIconUrl;
                forecastIconUrl =
                  "https://openweathermap.org/img/wn/" + newIcon + ".png";
